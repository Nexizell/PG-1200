...
public class GameCircleSocial : ISocialPlatform
{
	...
	{
		Action<bool> action = (simpleCallbacks.ContainsKey(response.userData) ? simpleCallbacks[response.userData] : null);
		if (action != null)
		{
	...
	private void OnRequestAchievementsCompleted(AGSRequestAchievementsResponse response)
	{
		...
		{
			Action<IAchievementDescription[]> action = (loadAchievementDescriptionsCallbacks.ContainsKey(response.userData) ? loadAchievementDescriptionsCallbacks[response.userData] : null);
			if (action != null)
			{
		...
		{
			Action<IAchievement[]> action2 = (loadAchievementsCallbacks.ContainsKey(response.userData) ? loadAchievementsCallbacks[response.userData] : null);
			if (action2 != null)
			{
	...
	{
		AGSSocialLeaderboard aGSSocialLeaderboard = (leaderboardForRequest.ContainsKey(response.userData) ? leaderboardForRequest[response.userData] : null);
		...
		Action<IScore[]> action2 = (loadScoresCallbacks.ContainsKey(response.userData) ? loadScoresCallbacks[response.userData] : null);
		if (action2 != null)
		{
