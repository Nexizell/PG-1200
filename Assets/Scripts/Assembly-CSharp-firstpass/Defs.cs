...
public sealed class Defs
{
	...
	public const string ShieldSpeedrunId = "shield_speedrun";

	public const string IosProductionBundleId = "zombiegun3d";

	public const string TrophiesNegativeKey = "RatingNegative";

	public const string TrophiesPositiveKey = "RatingPositive";

	public const string ConnectSceneName = "ConnectScene";

	public const string FIRST_ENTER_TO_MINI_GAMES = "ChooseMiniGameController.FIRST_ENTER_TO_MINI_GAMES";

	public const string TIME_LAST_GIVE_TICKETS_KEY = "ChooseMiniGameController.TIME_LAST_GIVE_TICKETS_KEY";
	...
	public static string sumInnapsKey;
	...
	public static int[] controlButtonSizes;
	...
	public const string localMultyKey = "localMultyKey";
	...
	public const string inappBonusesConfigKey = "inappBonusesConfigKey";

	public const string ratingSystemConfigKey = "rSCKeyV3";
	...
	public const string Tickets = "TicketsCurrency";
	...
	public static string continentKey;
	...
	public const int ratingCountForDuelMode = 300;

	public static Dictionary<string, string> bootsMaterialDict;

	public static bool useRatingLobbySystem;

	public const string SpecificalTerrainsMarkedFlag = "Environment.Terrains.SpecificalTerrainsMarkedFlag";

	public const string freeCheckpointsKey = "FreeCheckpointsKey";

	public const int hungerBonusForItem = 2;
	...
	public static bool isEnableInviteFromFriends
	{
		get
		{
			if (!isEnableLocalInviteFromFriends)
			{
	...
	public static bool isABTestBalansCohortActual
	{
		get
		{
			if (_isAbTestBalansCohortActual.HasValue)
			{
				if (_isAbTestBalansCohortActual != true)
				{
					return false;
				}
				return true;
	...
	static Defs()
	{
		...
		FireButton2X = 160;
		FireButton2Y = 337;
		controlButtonSizes = new int[9] { 80, 80, 120, 120, 144, 80, 120, 544, 102 };
		...
		LogoWidth = 8;
		LogoHeight = 8;
		SurvivalMaps = new string[7] { "Arena_Swamp", "Arena_Underwater", "Arena_Castle", "Arena_Space", "Arena_Hockey", "Arena_Mine", "Pizza" };
