		...
		_info = new Dictionary<string, PetInfo>
		{
			...
			},
			{
				...
				new PetInfo
				{
					...
					petExplode = true,
					explosionRadius = 3f,
					explosionImpulse = 50f,
					explosionDamageMultiplier = 1.5f,
					explosionPrefabName = "Explosion1",
					PositionInBanners = new Vector3(0.03137f, -0.363f, 3.0128f),
					RotationInBanners = new Vector3(0f, 154.398f, 0f),
					Parameters = new List<GadgetInfo.Parameter>
					{
					...
					Effects = new List<WeaponSounds.Effects> { WeaponSounds.Effects.Detonation }
				}
			},
			{
				"pet_chicken_up1",
