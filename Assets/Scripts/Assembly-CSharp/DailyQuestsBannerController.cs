...
public sealed class DailyQuestsBannerController : BannerWindow
{
	...
	private void Update()
	{
		if (blockingFon != null)
		{
			blockingFon.depth = ((ExpController.Instance != null && ExpController.Instance.WaitingForLevelUpView) ? 100000 : 100);
		}
	}
