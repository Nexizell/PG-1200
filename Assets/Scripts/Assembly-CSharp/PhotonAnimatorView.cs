...
public class PhotonAnimatorView : MonoBehaviour, IPunObservable
{
	...
	[HideInInspector]
	[SerializeField]
	protected internal bool ShowLayerWeightsInspector = true;

	[HideInInspector]
	[SerializeField]
	protected internal bool ShowParameterInspector = true;

	[HideInInspector]
	[SerializeField]
	protected internal List<SynchronizedParameter> m_SynchronizeParameters = new List<SynchronizedParameter>();

	[HideInInspector]
	[SerializeField]
	protected internal List<SynchronizedLayer> m_SynchronizeLayers = new List<SynchronizedLayer>();
