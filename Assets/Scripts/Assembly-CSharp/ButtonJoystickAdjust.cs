...
{
	[SerializeField]
	protected internal GameObject ZoneTopLeft;

	[SerializeField]
	protected internal GameObject ZoneBottonRight;
	...
	private void Start()
	{
		...
		{
			defaultControlSprite.SetActive(!GameConnect.isDaterRegim);
			daterControlSprite.SetActive(GameConnect.isDaterRegim);
		}
	}
