...
{
    public abstract class FacebookBase : IFacebook, IFacebookCallbackHandler, IFacebookImplementation
    {
        ...
        public FacebookBase(CallbackManager callbackManager)
        {
        ...
        public void OnAuthResponse(LoginResult result)
        {
