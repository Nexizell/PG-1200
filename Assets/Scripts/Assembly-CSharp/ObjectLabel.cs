...
public class ObjectLabel : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if ((GameConnect.isMiniGame && MiniGamesController.Instance != null && !MiniGamesController.Instance.isGo) || _weaponManager.myPlayer == null)
		{
			ResetTimeShow();
		}
		...
		try
		{
			...
			if (!isMenu)
			{
				...
				{
					Debug.LogError(string.Format("Rank is equal to {0}, but the range [0, {1}) expected.", new object[2]
					{
						myRanks,
						expController.marks.Length
					}));
				}
				else
				{
