...
public sealed class AdmobPerelivWindow : MonoBehaviour
{
	...
	public void Show()
	{
		...
		{
			_xpGuiVisibility = ExperienceController.sharedController.isShowRanks;
	...
	public void Hide()
	{
		...
		if (_xpGuiVisibility.HasValue)
		{
			if (ExperienceController.sharedController != null)
			{
				ExperienceController.sharedController.isShowRanks = _xpGuiVisibility.Value;
			}
			_xpGuiVisibility = null;
		}
	}
}
