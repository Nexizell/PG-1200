...
public class StarterPackItem : MonoBehaviour
{
	...
	public void SetData(StarterPackItemData itemData)
	{
		...
		if (priceByShopId != null)
		{
			...
			string text3 = ((priceByShopId.Currency == "Coins") ? LocalizationStore.Get("Key_0936") : LocalizationStore.Get("Key_0771"));
			realPriceItem.text = string.Format("{0} {1}", new object[2] { num2, text3 });
		}
	}
}
