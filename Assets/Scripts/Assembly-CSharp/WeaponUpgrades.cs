...
public static class WeaponUpgrades
{
	...
	static WeaponUpgrades()
	{
		...
		List<string> item151 = new List<string>
		{
			WeaponTags.laser_spear_Tag,
			WeaponTags.laser_spear_up1_Tag,
			WeaponTags.laser_spear_up2_Tag
		};
		upgrades.Add(item151);
		List<string> item152 = new List<string>
		{
			WeaponTags.nunchuks_Tag,
			WeaponTags.nunchuks_up1_Tag,
			WeaponTags.nunchuks_up2_Tag
		};
		upgrades.Add(item152);
		List<string> item153 = new List<string>
		{
			WeaponTags.casanova_Tag,
			WeaponTags.casanova_up1_Tag,
			WeaponTags.casanova_up2_Tag
		};
		upgrades.Add(item153);
		List<string> item154 = new List<string>
		{
			WeaponTags.romeo_and_juliette_Tag,
			WeaponTags.romeo_and_juliette_up1_Tag
		};
		upgrades.Add(item154);
		List<string> item155 = new List<string>
		{
			WeaponTags.double_dragon_Tag,
			WeaponTags.double_dragon_up1_Tag,
			WeaponTags.double_dragon_up2_Tag
		};
		upgrades.Add(item155);
		List<string> item156 = new List<string>
		{
			WeaponTags.magicbook_love_Tag,
			WeaponTags.magicbook_love_up1_Tag
		};
		upgrades.Add(item156);
		List<string> item157 = new List<string>
		{
			WeaponTags.Q_grenade_launcher_Tag,
			WeaponTags.Q_grenade_launcher_up1_Tag,
			WeaponTags.Q_grenade_launcher_up2_Tag
		};
		upgrades.Add(item157);
		List<string> item158 = new List<string>
		{
			WeaponTags.Q_machine_gun_Tag,
			WeaponTags.Q_machine_gun_up1_Tag,
			WeaponTags.Q_machine_gun_up2_Tag
		};
		upgrades.Add(item158);
		List<string> item159 = new List<string>
		{
			WeaponTags.Q_electrogun_Tag,
			WeaponTags.Q_electrogun_up1_Tag,
			WeaponTags.Q_electrogun_up2_Tag
		};
		upgrades.Add(item159);
		List<string> item160 = new List<string>
		{
			WeaponTags.Q_railgun_Tag,
			WeaponTags.Q_railgun_up1_Tag
		};
		upgrades.Add(item160);
		List<string> item161 = new List<string>
		{
			WeaponTags.Q_rocket_launcher_Tag,
			WeaponTags.Q_rocket_launcher_up1_Tag,
			WeaponTags.Q_rocket_launcher_up2_Tag
		};
		upgrades.Add(item161);
		List<string> item162 = new List<string>
		{
			WeaponTags.Q_shotgun_Tag,
			WeaponTags.Q_shotgun_up1_Tag,
			WeaponTags.Q_shotgun_up2_Tag
		};
		upgrades.Add(item162);
		List<string> item163 = new List<string>
		{
			WeaponTags.Q_plasma_gun_Tag,
			WeaponTags.Q_plasma_gun_up1_Tag,
			WeaponTags.Q_plasma_gun_up2_Tag
		};
		upgrades.Add(item163);
	}
