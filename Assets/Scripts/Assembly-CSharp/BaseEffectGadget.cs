public class BaseEffectGadget : ImmediateGadget
{
	...
	public override void Use()
	{
		...
		{
			WeaponManager.sharedManager.myPlayerMoveC.SetGadgetEffectActivation(effect, true);
		}
	}
	...
	{
		StartCooldown();
		WeaponManager.sharedManager.myPlayerMoveC.SetGadgetEffectActivation(effect, false);
	}
}
