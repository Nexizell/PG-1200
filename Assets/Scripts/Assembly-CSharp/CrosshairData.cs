...
public class CrosshairData 
{
	...
	public aimSprite leftUp = new aimSprite("", new Vector2(12f, 12f), new Vector2(8f, 8f));

	public aimSprite left = new aimSprite("aim_2", new Vector2(10f, 6f), new Vector2(5f, 0f));

	public aimSprite leftDown = new aimSprite("", new Vector2(0f, 0f), new Vector2(0f, 0f));
