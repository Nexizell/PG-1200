...
namespace Rilisoft
{
	...
	{
		[SerializeField]
		protected internal GameObject _rootObject;

		[SerializeField]
		protected internal GameObject _hpBarObject;

		[SerializeField]
		protected internal UI2DSprite _iconSprite;

		[SerializeField]
		protected internal Transform _HPIndicator;

		[SerializeField]
		protected internal UITexture _RewiveIndicator;
		...
		private void Update()
		{
			...
			{
				_iconSprite.sprite2D = Resources.Load<Sprite>(string.Format("Pets/Icons/{0}_icon", new object[1] { _myPetEngine.Info.IdWithoutUp }));
