...
namespace Rilisoft
{
	...
	public class EggData 
	{
		...
		public const string EGG_TOURNAMENT_WINNER = "egg_tournament_winner";
		...
		public static string GetRarityLocalizeKey(EggData eggData)
		{
			if (eggData == null)
			{
				return string.Empty;
			}
			if (eggData.Id == "egg_tournament_winner")
			{
				return "Key_2952";
			}
			switch (eggData.Rare)
			...
			case EggRarity.Champion:
				return "Key_2688";
			default:
				Debug.LogErrorFormat("LkeyForRarity: incorrect rarity: " + eggData.Rare);
				return "Key_2685";
			}
		}
	}
