...
namespace Rilisoft
{
	public static class LogsManager
	{
		...
		{
			m_loggingState = ((Storager.getInt("LogsManager.LoggingEnabledKey") == 1) ? LoggingState.EnabledByUserOrServer : LoggingState.Default);
		...
		public static void SetLoggingEnabled(bool enabled)
		{
			...
			Storager.setInt("LogsManager.LoggingEnabledKey", enabled ? 1 : 0);
		}
