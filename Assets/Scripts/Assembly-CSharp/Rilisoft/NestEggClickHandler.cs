...
namespace Rilisoft
{
	...
	{
		[SerializeField]
		protected internal GameObject _eggObject;

		[SerializeField]
		protected internal NestBanner _banner;

		[SerializeField]
		protected internal float _sensitivity = 0.1f;

		[SerializeField]
		protected internal float _thresholdPercent = 1f;
