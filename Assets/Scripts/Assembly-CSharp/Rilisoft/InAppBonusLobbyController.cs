...
namespace Rilisoft
{
	public class InAppBonusLobbyController : MonoBehaviour
	{
		...
		[SerializeField]
		protected internal PrefabHandler _scrollViewPrefabHandler;

		[SerializeField]
		protected internal UIWrapContent _scrollViewsRoot;

		[SerializeField]
		protected internal UIScrollView _scroll;

		[SerializeField]
		protected internal UICenterOnChild _centerOnChild;

		[SerializeField]
		protected internal float _rotateDelay = 2f;

		[Header("[ buttons grid settings ]")]
		[SerializeField]
		protected internal PrefabHandler _buttonViewPrefabHandler;

		[SerializeField]
		protected internal UIGrid _buttonsGrid;
		...
		private void UpdateViews()
		{
			...
			{
				_buttonsGrid.gameObject.SetActive(_cachedBonuses.Count > 1);
