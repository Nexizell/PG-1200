...
namespace Rilisoft
{
	public sealed class Invitation : MonoBehaviour
	{
		public UILabel nm;
		...
		public void KeepClanData()
		{
			...
			FriendsController.sharedController.tempClanLogo = clanLogoString ?? "";
			FriendsController.sharedController.tempClanName = nm.text ?? "";
		}
		...
		private void UpdateInfo()
		{
			...
			if (id != null && FriendsController.sharedController.playersInfo.TryGetValue(id, out value4) && value4.TryGetValue("player", out value5))
			{
				...
				rank.spriteName = "Rank_" + (text.Equals("0") ? "1" : text);
			}
		}
