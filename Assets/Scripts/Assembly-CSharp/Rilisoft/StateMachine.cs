...
namespace Rilisoft
{
	public class StateMachine<T> : MonoBehaviour
	{
		...
		[TextArea(5, 10)]
		[SerializeField]
		protected internal string _callHistory;
		...
		public void To(T stateId)
		{
			...
			CurrentState.In((_prevState != null) ? _prevState.StateId : default(T));
			if (this.OnStateChanged != null)
			{
				this.OnStateChanged(CurrentState.StateId, (_prevState != null) ? _prevState.StateId : default(T));
			}
		}
