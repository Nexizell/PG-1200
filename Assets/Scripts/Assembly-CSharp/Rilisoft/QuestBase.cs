...
namespace Rilisoft
{
	public abstract class QuestBase
	{
		...
		public Dictionary<string, object> ToJson()
		{
			...
			ApppendDifficultyProperties(dictionary);
			Dictionary<string, object> dictionary2 = new Dictionary<string, object>(3)
			{
				...
				{ "slot", Slot },
				{
					QuestConstants.GetDifficultyKey(Difficulty),
					dictionary
				},
				{
					"active",
					Convert.ToInt32(_active)
				},
				{
					"rewarded",
					Convert.ToInt32(Rewarded)
				}
			};
			AppendProperties(dictionary2);
			return dictionary2;
		}
