...
internal sealed class URLs
{
	...
	public static string ABTestViewBankURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				...
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/abTestViewBank/android2505/currentView.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/abTestViewBank/amazon/currentView.json";
			}
	...
	public static string SetLocalMultyUrl
	{
		get
		{
			return "https://cfg.pixelgun3d.com/config.json";
		}
	}
	...
	public static string ABTestBalansURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestBalans/android/abTest.php?key=0LjZB3GmACx15N7HJPYm";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestBalans/amazon/abTest.php?key=0LjZB3GmACx15N7HJPYm";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string ABTestBalansFolderURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestBalans/android/";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestBalans/amazon/";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string ABTestSandBoxURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/SandBox/abtestconfig_android.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/SandBox/abtestconfig_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string ABTestPathFormat
	{
		get
		{
			if (Defs.IsDeveloperBuild)
			{
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/{0}/abtestconfig_test.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/{0}/abtestconfig_android.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/{0}/abtestconfig_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/{0}/abtestconfig_wp.json";
			}
			return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/{0}/abtestconfig_ios.json";
		}
	}
	...
	public static string ABTestSpecialOffersURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/SpecialOffers/abtestconfig_android.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/SpecialOffers/abtestconfig_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string ABTestPolygonURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestPolygon/abtestconfig_android.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestPolygon/abtestconfig_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string ABTestAdvertURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestAdvert/abtestconfig_android.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestAdvert/abtestconfig_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string RatingSystemConfigURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ratingConfig/rating_android.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ratingConfig/rating_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string ABTestBalansActualCohortNameURL
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
				{
					return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestBalans/android/bCohortNameActual.json";
				}
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ABTests/abTestBalans/amazom/bCohortNameActual.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
	...
	public static string TutorialQuestConfig
	{
		get
		{
			if (Defs.IsDeveloperBuild)
			{
				return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/tutorial-quests/tutorial-quests-{0}.json", new object[1] { "test" });
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.IPhonePlayer)
			{
				return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/tutorial-quests/tutorial-quests-{0}.json", new object[1] { "ios" });
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.AndroidEdition == Defs.RuntimeAndroidEdition.GoogleLite)
				{
					return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/tutorial-quests/tutorial-quests-{0}.json", new object[1] { "android" });
				}
				if (Defs.AndroidEdition == Defs.RuntimeAndroidEdition.Amazon)
				{
					return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/tutorial-quests/tutorial-quests-{0}.json", new object[1] { "amazon" });
				}
				return string.Empty;
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
				return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/tutorial-quests/tutorial-quests-{0}.json", new object[1] { "wp8" });
			}
			return string.Empty;
		}
	}
	...
	public static string BuffSettings
	{
		get
		{
			string text = (StoreKitEventListener.IsPayingUser() ? "_paying.json" : ".json");
			if (Defs.IsDeveloperBuild)
			{
	...
	public static string NewAdvertisingConfig
	{
		get
		{
			...
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				if (Defs.RuntimeAndroidEdition.Amazon == Defs.AndroidEdition)
				{
					return FormatNewAdvertisingConfigUrl("advert-amazon", empty);
				}
				if (Defs.RuntimeAndroidEdition.GoogleLite == Defs.AndroidEdition)
				{
	...
	public static string MiniGameRatingUrl
	{
		get
		{
			return _miniGameRatingUrl.Value;
		}
	}
	...
	public static string PopularityMapUrl
	{
		get
		{
			...
			int currentLeague = (int)RatingSystem.instance.currentLeague;
			return "https://secure.pixelgunserver.com/mapstats/" + GlobalGameController.MultiplayerProtocolVersion + "_" + (int)(GameConnect.myPlatformConnect - 1) + "_" + (Defs.useRatingLobbySystem ? ("l" + currentLeague) : num.ToString()) + "_mapstat.json";
		}
	}
	...
	public static string GeoIPUrl
	{
		get
		{
			return "https://geoip.rilisoft.info/get_geo_info.php";
		}
	}
	...
	private static string InitializeTrafficForwardingConfigUrl()
	{
		if (Defs.IsDeveloperBuild)
		{
			return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/trafficForwarding/traffic_forwarding_{0}.json", new object[1] { "test" });
		}
		switch (BuildSettings.BuildTargetPlatform)
		{
		case RuntimePlatform.IPhonePlayer:
			return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/trafficForwarding/traffic_forwarding_{0}.json", new object[1] { "ios" });
		case RuntimePlatform.Android:
			switch (Defs.AndroidEdition)
			{
			case Defs.RuntimeAndroidEdition.GoogleLite:
				return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/trafficForwarding/traffic_forwarding_{0}.json", new object[1] { "android" });
			case Defs.RuntimeAndroidEdition.Amazon:
				return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/trafficForwarding/traffic_forwarding_{0}.json", new object[1] { "amazon" });
			default:
				return string.Empty;
			}
		case RuntimePlatform.MetroPlayerX64:
			return string.Format("https://secure.pixelgunserver.com/pixelgun3d-config/trafficForwarding/traffic_forwarding_{0}.json", new object[1] { "wp8" });
		default:
			return string.Empty;
		}
	}
	...
	private static string GetMiniGameRatingUrl()
	{
		return FormatMiniGameRatingUrl("rating-minigame-all");
	}
	...
	private static string FormatMiniGameRatingUrl(string name)
	{
		return string.Format(CultureInfo.InvariantCulture, "https://secure.pixelgunserver.com/pixelgun3d-config/rating-minigame/{0}.json", name);
	}
