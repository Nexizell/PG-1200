...
public class KillRateCheck
{
	...
	{
		LoadParameters();
		Dictionary<string, object> dictionary = Json.Deserialize(Storager.getString("killRateValues")) as Dictionary<string, object>;
		if (dictionary != null)
		{
	...
	{
		Storager.setString("LastKillRates", Json.Serialize(new int[2][] { kills, deaths }));
	}
	...
	private void SaveValues()
	{
		...
		Storager.setString("killRateValues", Json.Serialize(dictionary));
	}
