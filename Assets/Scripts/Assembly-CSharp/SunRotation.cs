...
public class SunRotation : MonoBehaviour
{
	...
	{
		if (!(TimeGameController.sharedController != null) || PhotonNetwork.room == null || string.IsNullOrEmpty(GameConnect.maxKillProperty) || !PhotonNetwork.room.customProperties.ContainsKey(GameConnect.maxKillProperty))
		{
			return;
		}
		int result = -1;
