...
public class ToggleFix : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			checkmark.color = new Color(checkmark.color.r, checkmark.color.g, checkmark.color.b, toggle.value ? 1f : 0f);
			background.color = new Color(background.color.r, background.color.g, background.color.b, toggle.value ? 0f : 1f);
		}
	}
