...
public class LevelBox
{
	...
	public int gems
	{
		get
		{
			if (!BalanceController.gemsBoxAwards.ContainsKey(PreviewNAme))
			{
				return 15;
			}
			return BalanceController.gemsBoxAwards[PreviewNAme];
		}
	}
	...
	public int coins
	{
		get
		{
			if (!BalanceController.coinsBoxAwards.ContainsKey(PreviewNAme))
			{
				return 15;
			}
			return BalanceController.coinsBoxAwards[PreviewNAme];
		}
	}
	...
	public int CompletionExperienceAward
	{
		get
		{
			if (!BalanceController.expBoxAwards.ContainsKey(PreviewNAme))
			{
				return 15;
			}
			return BalanceController.expBoxAwards[PreviewNAme];
		}
	}
