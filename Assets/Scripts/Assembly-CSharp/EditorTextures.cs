...
public sealed class EditorTextures : MonoBehaviour
{
	...
	public void SetStartCanvas(Texture2D _texure)
	{
		...
		int num3 = ((num < num2) ? Mathf.RoundToInt(num) : Mathf.RoundToInt(num2));
	...
	private void Update()
	{
		...
		Vector2 pos2 = ((touchCount > 0) ? new Vector2(touch.position.x, touch.position.y) : new Vector2(Input.mousePosition.x, Input.mousePosition.y));
