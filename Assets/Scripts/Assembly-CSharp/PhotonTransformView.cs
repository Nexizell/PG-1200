...
{
	[SerializeField]
	protected internal PhotonTransformViewPositionModel m_PositionModel = new PhotonTransformViewPositionModel();

	[SerializeField]
	protected internal PhotonTransformViewRotationModel m_RotationModel = new PhotonTransformViewRotationModel();

	[SerializeField]
	protected internal PhotonTransformViewScaleModel m_ScaleModel = new PhotonTransformViewScaleModel();
