...
public class UIFont : MonoBehaviour
{
	...
	[HideInInspector]
	[SerializeField]
	protected internal Rect mUVRect = new Rect(0f, 0f, 1f, 1f);

	[HideInInspector]
	[SerializeField]
	protected internal BMFont mFont = new BMFont();
	...
	[HideInInspector]
	[SerializeField]
	protected internal List<BMSymbol> mSymbols = new List<BMSymbol>();
	...
	[SerializeField]
	[HideInInspector]
	protected internal int mDynamicFontSize = 16;
	...
	private void Trim()
	{
		...
		{
			Rect rect = NGUIMath.ConvertToPixels(mUVRect, texture.width, texture.height, true);
