...
public sealed class Defs2
{
	...
	public static string ApplicationUrl
	{
		get
		{
			if (BuildSettings.BuildTargetPlatform != RuntimePlatform.Android || Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon)
			{
				...
				{
					return "http://pixelgun3d.com/get.html";
				}
				return "https://www.microsoft.com/ru-ru/store/games/pixel-gun-3d/9wzdncrdzvbf";
			}
			return "http://www.amazon.com/RiliSoft-Games-Pixel-Gun-3D/dp/B00I6IKSZ0";
		}
	}
	...
	public static void InitializeTier8_3_0Key()
	{
		if (!TierAfter8_3_0Initialized)
		{
			...
			{
				Storager.setInt(Defs.TierAfter8_3_0Key, ExpController.GetOurTier());
			}
