...
public class UIPanel : UIRect
{
	...
	[SerializeField]
	[HideInInspector]
	protected internal float mAlpha = 1f;
	...
	[SerializeField]
	[HideInInspector]
	protected internal Vector4 mClipRange = new Vector4(0f, 0f, 300f, 200f);

	[HideInInspector]
	[SerializeField]
	protected internal Vector2 mClipSoftness = new Vector2(4f, 4f);
	...
	[SerializeField]
	protected internal Vector2 mClipOffset = Vector2.zero;
