...
public class CharacterView : MonoBehaviour
{
	...
	{
		Rocket component = UnityEngine.Object.Instantiate(Resources.Load<GameObject>("Rocket"), Vector3.zero, Quaternion.identity).GetComponent<Rocket>();
	...
	{
		characterInterface.SetSkin(skin, (body.transform.childCount > 0) ? body.transform.GetChild(0).GetComponent<WeaponSounds>() : null);
	}

	public void UpdateHat(string hat)
	{
		string @string = Storager.getString(Defs.VisualHatArmor);
