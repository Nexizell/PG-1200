...
namespace I2.Loc
{
	...
	{
		[CompilerGenerated]
		internal sealed class _003CImport_Google_Coroutine_003Ed__12 : IEnumerator<object>, IEnumerator, IDisposable
		{
			private int _003C_003E1__state;

			private object _003C_003E2__current;

			public LanguageSource _003C_003E4__this;

			private WWW _003Cwww_003E5__1;
			...
			[DebuggerHidden]
			public _003CImport_Google_Coroutine_003Ed__12(int _003C_003E1__state)
			{
			...
			private bool MoveNext()
			{
				...
				case 0:
					...
					_003Cwww_003E5__1 = _003C_003E4__this.Import_Google_CreateWWWcall();
				...
				if (!_003Cwww_003E5__1.isDone)
				{
					_003C_003E2__current = null;
					_003C_003E1__state = 1;
					return true;
				}
				if (string.IsNullOrEmpty(_003Cwww_003E5__1.error) && _003Cwww_003E5__1.text != "\"\"")
				{
					PlayerPrefs.SetString("I2Source_" + _003C_003E4__this.Google_SpreadsheetKey, _003Cwww_003E5__1.text);
					PlayerPrefs.Save();
					_003C_003E4__this.Import_Google_Result(_003Cwww_003E5__1.text, eSpreadsheetUpdateMode.Replace);
					LocalizationManager.LocalizeAll();
					UnityEngine.Debug.Log("Done Google Sync '" + _003Cwww_003E5__1.text + "'");
				}
				else
				{
					UnityEngine.Debug.Log("Language Source was up-to-date with Google Spreadsheet");
				}
				UnityEngine.Object.Destroy(_003C_003E4__this.mCoroutineManager.gameObject);
				_003C_003E4__this.mCoroutineManager = null;
				return false;
			}
		...
		public string Export_CSV(string Category)
		{
			...
			foreach (TermData mTerm in mTerms)
			{
				...
				stringBuilder.AppendFormat(",{0}", new object[1] { mTerm.TermType.ToString() });
				stringBuilder.Append(",");
		...
		private static void AppendString(StringBuilder Builder, string Text)
		{
			if (!string.IsNullOrEmpty(Text))
			{
				...
				{
					Text = Text.Replace("\"", "\"\"");
					Builder.AppendFormat("\"{0}\"", new object[1] { Text });
				}
				else
				{
					Builder.Append(Text);
		...
		private IEnumerator Import_Google_Coroutine()
		{
			...
			if (www != null)
			{
				...
				if (string.IsNullOrEmpty(www.error) && www.text != "\"\"")
				{
					...
					LocalizationManager.LocalizeAll();
					UnityEngine.Debug.Log("Done Google Sync '" + www.text + "'");
				}
				else
				{
					UnityEngine.Debug.Log("Language Source was up-to-date with Google Spreadsheet");
		...
		public WWW Import_Google_CreateWWWcall(bool ForceUpdate = false)
		{
			...
			return new WWW(string.Format("{0}?key={1}&action=GetLanguageSource&version={2}", new object[3]
			{
		...
		public bool HasGoogleSpreadsheet()
		{
			...
			{
				return !string.IsNullOrEmpty(Google_SpreadsheetKey);
			}
			return false;
		}
