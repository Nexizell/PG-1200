...
namespace I2.Loc
{
    ...
    public class Localize : MonoBehaviour
    {
        ...
        private UnityEngine.UI.Text mTarget_GUIText;

        private TextMesh mTarget_TextMesh;

        private AudioSource mTarget_AudioSource;

        private UnityEngine.UI.RawImage mTarget_GUITexture;
        ...
        private void DoLocalize_GUITexture(string MainTranslation, string SecondaryTranslation)
        {
            ...
            {
                // TODO: PORT FOR 2019
                //mTarget_GUITexture.text = FindTranslatedObject<Texture>(MainTranslation);
            }
        }
