...
public class UICamera : MonoBehaviour
{
	...
	[CompilerGenerated]
	internal sealed class _003CReturnAccesToScreenSize_003Ed__182 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		[DebuggerHidden]
		public _003CReturnAccesToScreenSize_003Ed__182(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			case 3:
				_003C_003E1__state = -1;
				_003C_003E4__this.calculateWindowSize = true;
				return false;
			}
		}
	...
	public void ProcessTouches()
	{
		...
		for (int i = 0; i < num; i++)
		{
			...
			{
				Notify(currentTouch.current, "OnPressure", flag2 ? 0f : (currentTouch.pressure / currentTouch.maxPressure));
			}
			if (flag)
			{
				currentTouch.pressedCam = currentCamera;
