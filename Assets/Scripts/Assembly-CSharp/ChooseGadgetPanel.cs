...
public class ChooseGadgetPanel : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		try
		{
			...
			m_hintsShown = Storager.getInt("ChooseGadgetPanel.GADGET_PANEL_HINTS_SHOWN_KEY") == 1;
	...
	{
		if (m_hintsShown && Storager.getInt("ChooseGadgetPanel.GADGET_PANEL_HINTS_SHOWN_KEY") == 0)
		{
			Storager.setInt("ChooseGadgetPanel.GADGET_PANEL_HINTS_SHOWN_KEY", 1);
		}
	}
	...
	{
		if (Storager.getInt("GadgetsInfo.DefaultGadgetKey") != (int)GadgetsInfo.DefaultGadget)
		{
			Storager.setInt("GadgetsInfo.DefaultGadgetKey", (int)GadgetsInfo.DefaultGadget);
		}
	}

	private static void LoadDefaultGadget()
	{
		int num = Storager.getInt("GadgetsInfo.DefaultGadgetKey");
		if (num == 0)
		{
			num = 12500;
		}
