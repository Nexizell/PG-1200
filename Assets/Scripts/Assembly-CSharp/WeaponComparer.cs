...
{
	public static readonly string[] multiplayerWeaponsOrd = new string[547]
	{
		...
		WeaponTags.spleef_marker_2_Tag,
		...
		WeaponTags.spleef_marker_1_Tag,
		WeaponTags.KnifeTag,
		...
		WeaponTags.spleef_marker_3_Tag,
	...
	{
		string tag = ItemDb.GetByPrefabName(((Weapon)x).weaponPrefab.name.Replace("(Clone)", "")).Tag;
		string tag2 = ItemDb.GetByPrefabName(((Weapon)y).weaponPrefab.name.Replace("(Clone)", "")).Tag;
