...
{
	[CompilerGenerated]
	internal sealed class _003CSetSelectedPlayerWithPause_003Ed__38 : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public PrivateChatController _003C_003E4__this;

		public bool updateToogleState;
		...
		[DebuggerHidden]
		public _003CSetSelectedPlayerWithPause_003Ed__38(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			case 1:
				_003C_003E1__state = -1;
				_003C_003E4__this.SetSelectedPlayer(_003C_003E4__this.selectedPlayerID, updateToogleState);
				return false;
			}
		}
	...
	[CompilerGenerated]
	internal sealed class _003CUpdateFriendList_003Ed__47 : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CUpdateFriendList_003Ed__47(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			{
				_003C_003E1__state = -1;
				_003C_003E4__this.friendsWithInfo.Clear();
				for (int i = 0; i < FriendsController.sharedController.friends.Count; i++)
				{
					...
					{
						_003C_003E4__this.friendsWithInfo.Add(text);
					}
				}
				if (!_003C_003E4__this.wrapsInit)
				{
					_003C_003E4__this.friendsWrap.onInitializeItem = _003C_003E4__this.onFriendItemWrap;
					_003C_003E4__this.friendPreviewPrefab.transform.GetComponent<UIDragScrollView>().scrollView = _003C_003E4__this.friendsWrap.GetComponent<UIScrollView>();
					for (int j = 0; j < 16; j++)
					{
						GameObject gameObject = NGUITools.AddChild(_003C_003E4__this.friendsWrap.gameObject, _003C_003E4__this.friendPreviewPrefab);
						gameObject.name = "FriendPreviewItem_" + j;
						gameObject.GetComponent<UIToggle>().group = 3;
					}
					_003C_003E4__this.scrollFriends.ResetPosition();
					_003C_003E4__this.friendsWrap.SortAlphabetically();
					_003C_003E4__this.wrapsInit = true;
				}
				_003C_003E4__this._friends = new List<string>(_003C_003E4__this.friendsWithInfo);
				_003C_003E4__this._friends.Sort(_003C_003E4__this.SortByMessagesCount);
				_003C_003E4__this.friendsWrap.minIndex = _003C_003E4__this._friends.Count * -1;
				FriendPrevInChatItem[] componentsInChildren = _003C_003E4__this.friendsWrap.GetComponentsInChildren<FriendPrevInChatItem>(true);
				for (int k = 0; k < componentsInChildren.Length; k++)
				{
					_003C_003E4__this.UpdateItemInfo(componentsInChildren[k]);
				}
				if (!string.IsNullOrEmpty(_003C_003E4__this.selectedPlayerID) && !FriendsController.sharedController.friends.Contains(_003C_003E4__this.selectedPlayerID))
				{
					_003C_003E4__this.selectedPlayerID = string.Empty;
					_003C_003E4__this.SetSelectedPlayer(_003C_003E4__this.selectedPlayerID);
					_003C_003E4__this.OnKeyboardHide();
					_003C_003E4__this.sendMessageInput.DeselectInput();
				}
				if (_003C_003E4__this.wrapsInit)
				{
					_003C_003E4__this.friendsWrap.SortAlphabetically();
	...
	[CompilerGenerated]
	internal sealed class _003CRepositionNextFrame_003Ed__54 : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CRepositionNextFrame_003Ed__54(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 1:
				_003C_003E1__state = -1;
				_003C_003E4__this.messageTable.repositionNow = true;
				_003C_003E4__this.scrollMessages.ResetPosition();
				return false;
			}
		}
	...
	[CompilerGenerated]
	internal sealed class _003CResetpositionCoroutine_003Ed__59 : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CResetpositionCoroutine_003Ed__59(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
	...
	private void UpdateItemInfo(FriendPrevInChatItem previewItem)
	{
		if (_friends.Count > previewItem.myWrapIndex)
		{
			...
			if (!FriendsController.sharedController.friendsInfo.ContainsKey(text) || !FriendsController.sharedController.friendsInfo[text].TryGetValue<Dictionary<string, object>>("player", out value))
			{
				return;
			}
			...
			previewItem.GetComponent<UIToggle>().Set(selectedPlayerID == text);
		}
	...
	public IEnumerator UpdateFriendList(bool isUpdatePos = false)
	{
		...
		if (!wrapsInit)
		{
			...
			for (int j = 0; j < 16; j++)
			{
				GameObject obj = NGUITools.AddChild(friendsWrap.gameObject, friendPreviewPrefab);
				obj.name = "FriendPreviewItem_" + j;
				obj.GetComponent<UIToggle>().group = 3;
			}
		...
		for (int k = 0; k < componentsInChildren.Length; k++)
		{
			UpdateItemInfo(componentsInChildren[k]);
		}
	...
	private void MoveFriendWrapToPosition(float yPosition)
	{
		...
		scrollFriends.MoveRelative(new Vector3(0f, flag ? (0f - num3) : num3, 0f));
	...
	private void UpdateMessageItemInfo(PrivateMessageItem messageItem)
	{
		if (curListMessages.Count > messageItem.myWrapIndex)
		{
			...
			if (privateMessage.playerIDFrom.Equals(FriendsController.sharedController.id))
			{
				...
				messageItem.otherMessageLabel.text = "";
				if (privateMessage.message.Contains(Defs.SmileMessageSuffix))
				{
					...
					messageItem.yourMessageLabel.text = "";
	...
	public void SendPrivateMessageCore(string customMessage)
	{
		if (!string.IsNullOrEmpty(customMessage) || (!string.IsNullOrEmpty(sendMessageInput.value) && !sendMessageInput.value.Contains(Defs.SmileMessageSuffix)))
		{
			...
			ChatController.PrivateMessage item = new ChatController.PrivateMessage(FriendsController.sharedController.id, flag ? customMessage : FilterBadWorld.FilterString(sendMessageInput.value), Tools.CurrentUnixTime + 10000000, false, true);
			if (!ChatController.privateMessagesForSend.ContainsKey(selectedPlayerID))
			{
