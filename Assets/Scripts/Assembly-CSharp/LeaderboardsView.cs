	...
	public State CurrentState
	{
		...
		set
		{
			...
			if (craftersButton != null)
			{
				...
				Transform transform9 = craftersButton.gameObject.transform.FindChild("SpriteLabel");
				if (transform9 != null)
				{
					transform9.gameObject.SetActive(value != State.Crafters);
				}
				Transform transform10 = craftersButton.gameObject.transform.FindChild("ChekmarkLabel");
				if (transform10 != null)
				{
