...
public class UILabel : UIWidget
{
	...
	[SerializeField]
	[HideInInspector]
	protected internal int mFontSize = 16;
	...
	[HideInInspector]
	[SerializeField]
	protected internal bool mEncoding = true;
	...
	[HideInInspector]
	[SerializeField]
	protected internal Effect mEffectStyle;

	[HideInInspector]
	[SerializeField]
	protected internal Color mEffectColor = Color.black;

	[SerializeField]
	[HideInInspector]
	protected internal NGUIText.SymbolStyle mSymbols = NGUIText.SymbolStyle.Normal;

	[SerializeField]
	[HideInInspector]
	protected internal Vector2 mEffectDistance = Vector2.one;

	[SerializeField]
	[HideInInspector]
	protected internal Overflow mOverflow;
	...
	[HideInInspector]
	[SerializeField]
	protected internal Color mGradientTop = Color.white;

	[HideInInspector]
	[SerializeField]
	protected internal Color mGradientBottom = new Color(0.7f, 0.7f, 0.7f);
	...
	[SerializeField]
	[HideInInspector]
	protected internal bool mMultiline = true;
	...
	public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		if (effectStyle != 0)
		{
			...
			if (effectStyle == Effect.Outline || effectStyle == Effect.Outline8)
			{
				...
				if (effectStyle == Effect.Outline8 || Mathf.Abs(vector.y) >= 2.5f || Mathf.Abs(vector.x) >= 2.5f || fontSize < 32 || base.height <= 32)
				{
					num = size2;
					size2 = verts.size;
