...
public class ShurikenGadget : ThrowGadget
{
	...
	public override void CreateRocket(WeaponSounds weapon)
	{
		...
		{
			Rocket rocket = Player_move_c.CreateRocket(weapon, WeaponManager.sharedManager.myPlayerMoveC.myCurrentWeaponSounds.grenatePoint.position, WeaponManager.sharedManager.myPlayerMoveC.myCurrentWeaponSounds.grenatePoint.rotation);
			if (Defs.isMulti)
			{
