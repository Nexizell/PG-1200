...
{
	[SerializeField]
	protected internal UIWidget[] widgets;

	[SerializeField]
	protected internal Vector2 sizeFor4x3;

	[SerializeField]
	protected internal Vector2 sizeFor16x9;

	public bool isLabels;

	[SerializeField]
	protected internal int fontSizeFor4x3;

	[SerializeField]
	protected internal int fontSizeFor16x9;
	...
	private void Start()
	{
		...
		if ((double)((float)Screen.width / (float)Screen.height) > 1.7)
		{
