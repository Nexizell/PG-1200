...
public class PlayerMechBody : MonoBehaviour
{
	...
	public void ShowHitMaterial(bool hit, bool poison = false)
	{
		if (hit)
		{
			bodyRenderer.material.mainTexture = (poison ? SkinsController.poisonHitTexture : SkinsController.damageHitTexture);
			handsRenderer.material.mainTexture = (poison ? SkinsController.poisonHitTexture : SkinsController.damageHitTexture);
		}
		else
		{
