...
public sealed class VirtualCurrencyHelper
{
	...
	private static SaltedIntArray _coinInappsQuantity;
	...
	public static SaltedIntArray _gemsInappsQuantity;

	public static readonly int[] coinPriceIds;

	public static readonly int[] gemsPriceIds;

	public static readonly int[] offersPriceIds;
	...
	public static SaltedIntArray coinInappsQuantity
	{
		get
		{
	...
	public static SaltedIntArray gemsInappsQuantity
	{
		get
		{
	...
	public static ItemPrice Price(string key)
	{
		...
		if (GadgetsInfo.info.Keys.Contains(key))
		{
			...
			{
				int num = ((!(GadgetsInfo.FirstForOurTier(key) == key)) ? 1 : 0);
	...
	static VirtualCurrencyHelper()
	{
		...
		_coinInappsQuantity = new SaltedIntArray(_coinInappsQuantityDefault);
		...
		_gemsInappsQuantity = new SaltedIntArray(_gemsInappsQuantityDefault);
		coinPriceIds = new int[7] { 1, 3, 5, 10, 20, 50, 100 };
		gemsPriceIds = new int[7] { 1, 3, 5, 10, 20, 50, 100 };
		offersPriceIds = new int[7] { 1, 3, 5, 10, 20, 50, 100 };
	...
	private static void AddPriceForArmor(string armor, int amount)
	{
		...
		{
			_armorPricesDefault.Add(armor, new ItemPrice(amount, (armor == "Armor_Adamant_3") ? "GemsCurrency" : "Coins"));
		}
	}
	...
	private static Dictionary<string, decimal> InitializeReferencePrices()
	{
		...
		{
			{
				StoreKitEventListener.inappOffersIds[0],
				0.99m
			},
			{
				StoreKitEventListener.inappOffersIds[1],
				2.99m
			},
			{
				StoreKitEventListener.inappOffersIds[2],
				4.99m
			},
			{
				StoreKitEventListener.inappOffersIds[3],
				9.99m
			},
			{
				StoreKitEventListener.inappOffersIds[4],
				19.99m
			},
			{
				StoreKitEventListener.inappOffersIds[5],
				49.99m
			},
			{
				StoreKitEventListener.inappOffersIds[6],
				99.99m
			},
			{ "coin1", 0.99m },
			{ "coin7", 2.99m },
