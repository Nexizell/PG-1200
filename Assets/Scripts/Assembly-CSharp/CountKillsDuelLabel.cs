...
public class CountKillsDuelLabel : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (enemyKills)
		{
			...
			{
				b = ((DuelController.instance.opponentNetworkTable.CountKills >= 0) ? DuelController.instance.opponentNetworkTable.CountKills : DuelController.instance.opponentNetworkTable.oldCountKills);
			}
		}
		else
		{
