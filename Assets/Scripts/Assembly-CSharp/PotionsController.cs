...
public sealed class PotionsController : MonoBehaviour
{
	...
	{
		if (nm != null && activePotions != null)
		{
			return activePotions.ContainsKey(nm);
		}
		return false;
	}
	...
	public void ActivatePotion(string potion, Player_move_c move_c, Dictionary<string, object> pars, bool isAddTimeOnActive = false)
	{
		...
		{
			activePotions.Add(potion, GameConnect.isDaterRegim ? 180f : potionDurations[potion + GearManager.CurrentNumberOfUphradesForGear(potion)]);
