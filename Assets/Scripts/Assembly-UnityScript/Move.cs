...
public class Move : MonoBehaviour
{
    ...
    public ParticleSystemRenderer smokeStem;
    ...
    {
        yield return new WaitForSeconds(this.smokeDestroyTime);
    ...
    public virtual void Update()
    {
        ...
        if (destroyEnabled)
        {
            ParticleSystemRenderer particleRenderer = (ParticleSystemRenderer)GetComponent(typeof(ParticleSystemRenderer));
