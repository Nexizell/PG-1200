...
namespace System.Reflection
{
	public class TypeInfo : Type
	{
		...
		public override Assembly Assembly
		{
			get
			{
				return underlyingType.Assembly;
			}
		}
		...
		public override string Namespace
		{
			get
			{
				return underlyingType.Namespace;
			}
		}
		...
		public override Type UnderlyingSystemType
		{
			get
			{
				return underlyingType.UnderlyingSystemType;
			}
		}
		...
		{
			return typeInfoMap.GetValue(type, (Type _) => new TypeInfo(type));
		}
